...
@section('content')
    <div class="container" style="margin-top: 50px; margin-bottom: 50px">
        <div class="login-page__info d-flex justify-content-between align-items-center">
            <p class="login-page__info__item">Resources - DNA Learning center.</p>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="m-0 p-0" action="{{ route('dnaresource.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-3">
                                    <textarea id="description" class="form-control" name="description" value="{{ old('description') }}" placeholder="description..."></textarea>
                        ...
                        <tbody>
                            @foreach ($dnaresources as $data)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            {{-- <a href="{{ route('data.edit', $data->id) }}" class="btn btn-primary btn-sm rounded-0">Edit</a> --}}
                                            <form class="m-0 p-0" action="{{ route('dnaresource.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                                @csrf
                                                @method('DELETE')
