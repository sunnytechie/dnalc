            ...
            <div class="col-md-9">
                <div class="about-two__right">
                    <div class="about-two__top">
                        ...
                        <div>
                            <img style="width: 100%; height: 450px; object-fit: cover;" src="{{ asset('assets/images/dna/18.jpeg') }}" alt="">
                        </div>
                        <h5 class="mt-4">Doctoral Research Designs & Experiments
                        </h5>
                        <p class="about-text">In addition to the use of DNALC facilities for doctoral level research and mentorship, we offer bench spaces, mini libraries and lockers to researchers working towards their doctorates or just conducting research as a doctorate degree holder.
                        </p>
                        <p class="about-text">For reservations and enquiries, send an email to “the Assistant Director, Training and Research, DNALC Nigeria” via info@dnalcnigeria.org or info.dnalcnigeria@gmail.com.
                        </p>
