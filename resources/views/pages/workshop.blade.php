        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div>
                    <div class="about-two__top mb-2">
                        <div class="sec-title text-start wow fadeInUp" data-wow-duration='1500ms'>
                            ...
                            <h3 class="sec-title__title">ANNUAL SCHEDULE OF WORKSHOPS & COURSES
                            </h3><!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-success table-striped table-bordered shadow table-hover">
                        <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            @foreach ($workshops as $workshop)
                                <tr>
                                    ...
                                    <td>{{ $workshop->type }}</td>
                                    <td>{{ \Carbon\Carbon::parse($workshop->start_date)->format('j M Y') }}</td>
                                    <td>{{ \Carbon\Carbon::parse($workshop->end_date)->format('j M Y') }}</td>
                                    <td>
                                        <a href="{{ route('workshop.application', $workshop->id) }}" class="btn btn-default btn-md" style="color: #27CD3A">Register</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
