            ...
            <div class="col-md-9">
                <div class="about-two__right">
                    <div class="about-two__top">
                        ...
                        <div>
                            <img style="width: 100%; height: 450px; object-fit: cover;" src="{{ asset('assets/images/dna/23.png') }}" alt="">
                        </div>
                        <h5 class="mt-4">Senior Secondary School Internships
                        </h5>
                        <p class="about-text">The S3INT program is a novel opportunity created at DNALC Nigeria to improve the drive and knowledge of senior secondary level students who are enthusiastic to work in the field of science. This unique program emphasizes the need for academic mentorship for these budding scientists that are either preparing for Senior school exams or has just finished.
                        </p>
                        <p class="about-text">Also, while working with a Senior Scientist on a funded project, the student intern receives some remuneration for all assistance rendered during the duration of work.
                        </p>
